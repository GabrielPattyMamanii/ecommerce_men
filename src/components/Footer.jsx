      ...
      <div className="relative z-10 px-6 md:px-10 lg:px-40 flex flex-col gap-12">
        ...
        <div className="pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-5">
          ...
          <div className="flex gap-5 items-center">
            ...
            <a className="text-slate-400 hover:text-primary transition-all transform hover:scale-110" href="#" aria-label="WhatsApp">
            ...
            <a className="text-slate-400 hover:text-primary transition-all transform hover:scale-110" href="#" aria-label="TikTok">
            ...
            <a className="text-slate-400 hover:text-primary transition-all transform hover:scale-110" href="#" aria-label="Instagram">
